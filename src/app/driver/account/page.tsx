...
export default function DriverAccountPage() {
  ...
  const [view, setView] = useState<"menu" | "profile" | "vehicle">("menu");
    ...
    return (
      <div className="min-h-screen bg-white pt-28 pb-24 md:pb-8 px-4 md:px-8">
        <button
          ...
          className="fixed top-24 left-6 md:left-28 z-50 bg-white p-3 rounded-full border border-gray-300 shadow-sm hover:shadow-md hover:border-gray-400 transition-all duration-300 group"
        >
      ...
      <div className="max-w-xl mx-auto space-y-6">
        ...
        >
          <div className="bg-white p-4 rounded-2xl shadow-sm border border-gray-100 text-center">
            <p className="text-2xl font-bold text-[#00B388]">$4.2k</p>
        ...
        {/* Vehicle Card */}
        <div
          className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100 animate-slide-up"
